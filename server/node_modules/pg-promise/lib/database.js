 ...
 * Database connection details, which can be any of the following:
 * 
...
function Database(cn, dc, config) {
     ...
     *
     * **NOTE:** Even though this method exposes a {@link external:Client Client} object via property `client`, you cannot call
     * `client.end()` directly, or it will throw {@link external:Error Error} = `Cannot invoke client.end() directly.`
     * You can only call method `done()` to release the connection.
     *
     ...
     * create a new {@link external:Client Client} object, and call its `connect` method.
     *
     * **WARNING:**
     *
     * Do not use this option for regular query execution, because it exclusively occupies one physical connection,
     * and therefore cannot scale. This option is only suitable for a global connection usage, such as database event listeners.
     *
    ...
    function extend(ctx, obj) {
         ...
         * - when 1 or more rows are returned, it resolves with the array of rows.
         *
         * @see {@link Database.manyOrNone manyOrNone}
         * 
         */
